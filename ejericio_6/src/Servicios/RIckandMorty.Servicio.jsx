...
import { API_RICKMORTY } from "../componentes/Constantes/Api.Constantes";

class RickAndMortyServicio {
...
export default new RickAndMortyServicio() //esto nos va a permitir usarla desde donde necesitemos
